...
echo ""
echo "Gateway API stack is ready."
echo "After installing Penpot with gateway.enabled=true, expose Envoy locally with:"
echo "  ${ROOT_DIR}/scripts/forward_gateway.sh"
